...
//static const char *USX_FREQ_SEQ_DFLT[] = {"\": \"", "\": ", "</", "=\"", "\":\"", "://","https://", "www.", ".com", "http://", ".org", ".net",".cc","magnet:","xt=urn:btih:","xt=urn:sha1:",".co",".xyz",".info",".moe",".io","baidu","tieba","google","pan","csdn","blog","bbs","bilibili",".tv","163","sohu","baijiahao","pixiv","pornhub","onlyfans","hentai"};
static const char *USX_FREQ_SEQ_DFLT[] = {"\": \"", "\": ", "</", "=\"", "\":\"", "://"};
/// Frequently occuring sequences in text content
//static const char *USX_FREQ_SEQ_TXT[] = {" the ", " and ", "tion", " with", "ing", "ment"};
/// Frequently occuring sequences in URL content
//static const char *USX_FREQ_SEQ_URL[] = {"https://", "www.", ".com", "http://", ".org", ".net"};
/// Frequently occuring sequences in JSON content
//static const char *USX_FREQ_SEQ_JSON[] = {"\": \"", "\": ", "\",", "}}}", "\":\"", "}}"};
/// Frequently occuring sequences in HTML content
//static const char *USX_FREQ_SEQ_HTML[] = {"</", "=\"", "div", "href", "class", "<p>"};
/// Frequently occuring sequences in XML content
//static const char *USX_FREQ_SEQ_XML[] = {"</", "=\"", "\">", "<?xml version=\"1.0\"", "xmlns:", "://"};

/// Commonly occuring templates (ISO Date/Time, ISO Date, US Phone number, ISO Time, Unused)
static const char *USX_TEMPLATES[] = {"tfff-of-tfTtf:rf:rf.fffZ", "tfff-of-tf", "(fff) fff-ffff", "tf:rf:rf", 0};
